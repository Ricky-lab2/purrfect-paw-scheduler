  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-pet-blue-dark text-white shadow-lg flex items-center justify-center hover:bg-pet-blue hover:scale-105 transition-all md:bottom-24"
